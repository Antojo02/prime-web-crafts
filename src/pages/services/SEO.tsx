      ...
      <section ref={heroRef} className="pt-32 pb-20 relative overflow-hidden">
        ...
        <motion.div style={{ y: heroY, opacity: heroOpacity, scale: heroScale }} className="container-tight relative z-10">
          <motion.div variants={staggerContainer} initial="hidden" animate="visible" className="max-w-3xl">
            <motion.span variants={fadeUp3D} className="inline-block px-4 py-2 rounded-full bg-primary/10 text-primary text-sm font-medium mb-6">SEO & Performance</motion.span>
            ...
            <motion.p variants={fadeUp3D} className="text-xl text-muted-foreground mb-8">Estrategias de SEO probadas para que tu negocio aparezca en los primeros resultados de búsqueda.</motion.p>
